...
- **The owner's top three** (2026-09-25) are the three-year leaders: D609
  (#2), CB51 (#25) and CBE3 (#18). Trading Micron is fine; only holding it
  is out. They run on paper from that day, $25,000 each, and the split bots
  were retired.
